              ...
              <div style="background: #f7f7f7; padding: 40px 20px; font-family: 'Nunito', sans-serif;">
                <div style="max-width: 480px; margin: 0 auto; background: white; border-radius: 24px; padding: 40px 32px; box-shadow: 0 4px 16px rgba(0,0,0,0.08);">
                  ...
                  <div style="text-align: center; margin: 24px 0 0;">
                    <a href="${process.env.BETTER_AUTH_URL || "https://codequestts.vercel.app"}/dashboard" style="background: #58CC02; color: white; padding: 14px 36px; border-radius: 999px; text-decoration: none; font-family: 'Fredoka', sans-serif; font-weight: 700; font-size: 16px; display: inline-block; box-shadow: 0 4px 0 #CC7030;">Start Your Quest →</a>
                  </div>
